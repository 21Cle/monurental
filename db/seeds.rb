...
monument1 = Monument.create!(name: "Big Ben", address: "London SW1A 0AA", price_per_night: 2500, capacity:200, description: "It's a big clock named Ben", rating: 4.2, theme: "Clock", city: "London", country: "United Kingdom", user_id: user1.id, latitude: 51.5007325, longitude: -0.1249943, utilities: ["sound system", "lighting", "catering", "VIP seating", "photographer", "security", "bartender", "wait staff", "parking", "stage", "decorations", "projection screens", "smoke machines", "confetti cannons", "fireworks", "karaoke machine", "photo booth", "strobe lights", "uplighting"])
monument2 = Monument.create!(name: "Tour Eiffel", address: "Champ de Mars, 5 Av. Anatole France, 75007 Paris", price_per_night: 2800, capacity: 2000, description: "That big metal thingy in the middle of Paris", rating: 3.8, theme: "Antenna", city: "Paris", country: "France", user_id: user1.id, latitude: 48.8583736, longitude: 2.2922926, utilities: ["sound system", "lighting", "catering", "VIP seating", "photographer", "security", "bartender", "wait staff", "parking", "stage", "decorations", "projection screens", "smoke machines", "confetti cannons", "fireworks", "karaoke machine", "photo booth", "strobe lights", "uplighting"])
monument3 = Monument.create!(name: "Taj Mahal", address: "Dharmapuri, Forest Colony, Tajganj, Agra, Uttar Pradesh 282001", price_per_night: 8200, capacity: 5000, description: "Would Mumtaz Mahal and Shah Jahan approve of you partying in their last resting place? Probably not. But we won't tell if you don't.", rating: 4.9, theme: "Mausoleum", city: "Agra", country: "India", user_id: user1.id, latitude: 27.1750855, longitude: 78.0414265, utilities: ["sound system", "lighting", "catering", "VIP seating", "photographer", "security", "bartender", "wait staff", "parking", "stage", "decorations", "projection screens", "smoke machines", "confetti cannons", "fireworks", "karaoke machine", "photo booth", "strobe lights", "uplighting"])
monument4 = Monument.create!(name: "The Great Pyramid of Giza", address: "Al Haram, Nazlet El-Semman, Al Giza Desert, Giza Governorate 3512201", price_per_night: 3700, capacity: 930, description: "Big Triangular Tomb of a guy named Khufu. We do not take responsibility if you get lost in there.", rating: 4.8, theme: "Tomb", city: "Giza", country: "Egypt", user_id: user2.id, latitude: 29.9792391, longitude: 31.1320132, utilities: ["sound system", "lighting", "catering", "VIP seating", "photographer", "security", "bartender", "wait staff", "parking", "stage", "decorations", "projection screens", "smoke machines", "confetti cannons", "fireworks", "karaoke machine", "photo booth", "strobe lights", "uplighting"])
monument5 = Monument.create!(name: "Château de Versailles", address: "Place d'Armes, 78000 Versailles", price_per_night: 8600, capacity: 5700, description: "Some guy named Louis used to party in there. He doesn't have all of his head now so he can't anymore, But you can!", rating: 3.1, theme: "Pompous Castle", city: "Versailles", country: "France", user_id: user2.id, latitude: 48.8049426, longitude: 2.1198078, utilities: ["sound system", "lighting", "catering", "VIP seating", "photographer", "security", "bartender", "wait staff", "parking", "stage", "decorations", "projection screens", "smoke machines", "confetti cannons", "fireworks", "karaoke machine", "photo booth", "strobe lights", "uplighting"])
...
file = URI.open("https://res.cloudinary.com/ddd2hwkfz/image/upload/v1679668227/wall-18_t6kgke.jpg")
